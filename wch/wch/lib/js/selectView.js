function selectView() {
    layui.use('table', function () {
        ...
        table.render({
            ...
            , method: 'POST'
            , url: '/tool/admin/select/GetCourse.ashx'
            ...
            , cols: [[
                ...
                , { fixed: 'right', title: '操作', toolbar: '#barDemo1', width: 165, align: 'center' }
            ]]
            , page: true
        ...
        table.on('tool(context)', function (obj) {
            var data = obj.data;
            if (obj.event === 'choice') {
                layer.confirm('真的选这门课', function (index) {
                    console.log(obj);
                    myPost("/tool/admin/select/AddCourse.ashx",
                        { timeID:data.TimeID},
                        function (val, adata) {
