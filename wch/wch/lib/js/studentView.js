function studentView() {
    ...
    layui.use(['form', 'layedit', 'laydate', 'table'], function(){
        ...
        table.render({
            ...
            , cellMinWidth: 80
            , height: 'full-300'
            , url: '/tool/admin/student/GetStu.ashx'
            , toolbar: '#toolbarStudentView' //开启头部工具栏，并为其绑定左侧模板
            ...
            , cols: [[
                ...
                , { field: 'StuID', title: '学号', fixed: 'left', sort: true }
                , { field: 'StuName', title: '学生姓名' }
                , {
                    field: 'Gender', title: '性别', sort: true, templet: function (res) {
                        return res.Gender == 1 ? '男' : '女';
                    }
                }
                , { field: 'ClassName', title: '班级号' }
